...
public class VerticalChildViewPager extends VerticalViewPager {

    public VerticalChildViewPager(Context context) {
        super(context);
    }

    public VerticalChildViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
